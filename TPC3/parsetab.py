...
_lr_productions = [
  ...
  ('dic -> Es','dic',1,'p_1','myYacc.py',11),
  ('Es -> E LINHA_B Es','Es',3,'p_2','myYacc.py',16),
  ('Es -> E','Es',1,'p_3','myYacc.py',20),
  ('E -> Itens','E',1,'p_4','myYacc.py',24),
  ('Itens -> Item , Itens','Itens',3,'p_5','myYacc.py',31),
  ('Itens -> Item','Itens',1,'p_6','myYacc.py',35),
  ('Item -> AtrC','Item',1,'p_7','myYacc.py',39),
  ('Item -> Ling','Item',1,'p_8','myYacc.py',44),
  ('AtrC -> ID : VALOR','AtrC',3,'p_9','myYacc.py',49),
  ('Ling -> IDL : Ts','Ling',3,'p_10','myYacc.py',53),
  ('Ts -> Ts ; T','Ts',3,'p_11','myYacc.py',59),
  ('Ts -> T','Ts',1,'p_12','myYacc.py',63),
  ('T -> - VALOR AtrTs','T',3,'p_13','myYacc.py',67),
  ('AtrTs -> AtrTs2','AtrTs',1,'p_14','myYacc.py',73),
  ('AtrTs -> <empty>','AtrTs',0,'p_15','myYacc.py',77),
  ('AtrTs2 -> AtrTs2 AtrT','AtrTs2',2,'p_16','myYacc.py',81),
  ('AtrTs2 -> AtrT','AtrTs2',1,'p_17','myYacc.py',85),
  ('AtrT -> + ID : VALOR','AtrT',4,'p_19','myYacc.py',89),
]
